...
function uib_zen_views_pre_render(&$view) {
  global $language;
  $current_lang = $language->language;
  if ($view->name == 'calendar' && $view->current_display == 'block_3' && $current_lang == 'nb') {
    foreach ($view->result as $key => $result) {
      ...
      $view->result[$key]->field_data_field_uib_event_type_field_uib_event_type_value = $event_type;
    }
  }
}
