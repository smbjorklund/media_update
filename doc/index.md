...
describing a new behaviour, a bug, or an improvement to the structure of the code.
For new behaviours, the issue should explain the rationale for the proposed
change and how the application will work with it.  A bug report
...
These issues are prioritized into releases, implemented, reviewed/merged, tested, and
then released.  The [workflow document](workflow.html) describes how you go about
working in on issues in different roles.
